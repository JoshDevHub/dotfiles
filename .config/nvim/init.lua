...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>/', builtin.oldfiles, { desc = 'Grep files' })
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      _timers = {}
      local function setup_ruby_lsp_diagnostics(client, buffer)
      ...
      local servers = {
        ...
        ruby_lsp = {
          ...
          on_attach = function(client, buffer)
            setup_ruby_lsp_diagnostics(client, buffer)
          end,
        },
        stimulus_ls = {
